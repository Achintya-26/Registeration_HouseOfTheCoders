...
export default function Navbar({ isMember, setIsMember }) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            toast.success("Welcome Member! You are eligible for the discounted prize", { duration: 3000 });
        ...
        <nav className="bg-darkBrown-700 shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col sm:flex-row justify-between items-center py-4">
                    ...
                    {/* Button Section - Stack below brand text on small screens */}
                    <div className="mt-2 w-full sm:w-auto">
                        {!isLoggedIn && !isMember && (
                            <div className="p-4 rounded-md flex justify-center"> {/* Yellow div for small screens */}
                                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                                    <DialogTrigger asChild>
                                        <Button variant="outline" className="hover:bg-yellow-100">
